...
func RulesSheet(v RulesSheetView) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "</span><h1>Regeln</h1><p class=\"sheet-lead\">Worauf wir uns an der Platte geeinigt haben.</p><dl class=\"rules\"><div><dt>Aufschlag diagonal (&raquo;Acker&laquo;)</dt><dd>Der Ball springt erst auf der eigenen Hälfte auf und muss danach auf der diagonal gegenüberliegenden Hälfte des Gegners aufkommen &mdash; wie im Doppel. Kommt er woanders auf, geht der Punkt an den Gegner.</dd></div><div><dt>Der erste Aufschlag wird ausgespielt</dt><dd>Vor dem ersten Satz wirft ein Spieler den Ball ein, und wer den Ballwechsel gewinnt, schlägt zuerst auf. In jedem weiteren Satz beginnt, wer den vorherigen verloren hat.<strong>Im Turnier nicht:</strong> dort steht im Spielplan, wer auf welcher Seite beginnt und aufschlägt. Bei achtundzwanzig Paarungen wäre Einwerfen der halbe Nachmittag.</dd></div><div><dt>Seitenwechsel nach jedem Satz</dt><dd>Nach jedem Satz werden die Seiten getauscht. Wer wo steht, entscheidet über Licht, Zug und die Tischseite mit der Delle &mdash; über einen ganzen Satz gerechnet ist das kein Detail.</dd></div><div><dt>Aufschlagwechsel nach ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `rules.templ`, Line: 72, Col: 69}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `rules.templ`, Line: 75, Col: 73}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var6))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, " Punkte am Stück auf &mdash; egal, wer sie holt. Danach wechselt der Aufschlag.</dd></div><div><dt>Zwei Punkte Abstand</dt><dd>Ein Satz geht bis ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `rules.templ`, Line: 83, Col: 53}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `rules.templ`, Line: 84, Col: 46}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `rules.templ`, Line: 84, Col: 89}
			}
